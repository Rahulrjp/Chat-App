...
const ChatArea = ({
    ...
    return (
        <div className="flex-1 min-w-0 flex flex-col bg-[#F8FAFC] dark:bg-slate-950 transition-colors duration-200">
            <div className="h-16 flex items-center justify-between px-4 sm:px-6 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 shadow-sm z-10 transition-colors duration-200">
                <div className="flex items-center min-w-0">
                    <button
                        onClick={onCloseChat}
                        className="md:hidden mr-3 p-2 -ml-2 rounded-full hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 shrink-0">
                    ...
                    <div
                        ...
                        <div className="min-w-0">
                            <h2 className="text-sm font-semibold truncate">{activeContact.name}</h2>
                            <p className="text-xs text-slate-500 dark:text-slate-400 truncate">{activeContact.online ? "Active now" : "Offline"}</p>
                        </div>
                    </div>
                </div>
            ...
            <div className="bg-white dark:bg-slate-900 p-2.5 xs:p-4 border-t border-slate-200 dark:border-slate-800 flex flex-col relative z-20 transition-colors duration-200">
                {isSelectMode ? (
                    ...
                    <>
                        ...
                        <form onSubmit={submitMessage} className="flex items-end gap-1.5 xs:gap-2 sm:gap-3 max-w-5xl mx-auto w-full">
                            <div className="flex items-center space-x-0.5 xs:space-x-1 sm:space-x-2 text-slate-400 pb-2">
                                <button
                                    type="button"
                                    onClick={() => mediaInputRef.current?.click()}
                                    className="p-1.5 xs:p-2 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-full transition-colors">
                            ...
                            <div className="flex-1 relative">
                                <input
                                    ...
                                    className="w-full bg-slate-100 dark:bg-slate-800 rounded-full pl-3.5 pr-10 py-2.5 xs:pl-4 xs:pr-12 xs:py-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all shadow-inner text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 border border-transparent dark:border-slate-700"
                                />
                                <button
                                    type="button"
                                    onClick={() => setShowEmojiPicker(!showEmojiPicker)}
                                    className="absolute right-2.5 xs:right-3 top-1/2 -translate-y-1/2 p-1 xs:p-1.5 text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                            ...
                            <button
                                ...
                                className="bg-indigo-600 text-white p-2.5 xs:p-3 rounded-full hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-md active:scale-95 shrink-0 border border-transparent dark:border-indigo-500">
